    ...
    return (
        <div className="mt-5" style={{ backgroundColor: "var(--normal-color)" }}>
            <footer className="footer container mx-auto  pt-24 pb-24" >
                <div className='' >
                    <Image src={footer_logo} alt='' data-aos="fade-right"></Image>
                    <p className='pt-4 fbrand-text' data-aos="fade-right">We take care of your health with <br /> regular and fun exercise</p>
                    <div className="grid grid-flow-col gap-4 pt-4" data-aos="fade-right">
                ...
                <div className='footer-link' >
                    <div className='flex flex-col' data-aos="fade-right">
                        <p className="footer-title">Program</p>
